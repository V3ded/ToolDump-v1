...
namespace SharpSectionJectDLL
{
    public class SharpSectionJectDLL
    {
        ...
        public static void Inj(string arg1, string arg2, string arg3)
        {
            ...
            if (args.Length == 3)
            {
                ...
                Console.WriteLine(@"Usage: [SharpSectionJectDLL.SharpSectionJectDLL]::Inj(<pid/proc_name>, <b64_sc>, <sc_pass>)");
